...
#转换框架的实现，利用基本框架可实现传统机器学习算法中的朴素贝叶斯和决策树
class TransformationBase(Basic):
    def __init__(self, *args, **kwargs):
        #*args, **kwargs是朴素神经网络中的各种参数；_transform_ws转换所需的权值矩阵的设置；_transform_bs转化所需的偏置量的设置
    ...
    #初始化模型时，除了基本框架所需初始化外还要做一些额外的和模型转换相关的事情
